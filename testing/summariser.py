...
def get_ext(text):
    ext=""
    file_name=""
    text=re.sub(r'\b(ultron|hey|ok|create|make|please|a|an|file|can you|folder|named|with name|name|of)\b', '', text, flags=re.IGNORECASE).strip()
    print(text)
    if "python" in text:
        ext = ".py"
            ...
            try:
                if ext==".json" or ext==".py" or ext==".css" or ext==".html" or ext==".js" or ext==".csv":
                    with open(f"{os.getcwd()}/{filename}{ext}","w"):
                        pass
                    print(")Sir,you can check the file in your current working directory.")
                
                else:
                    with open(fr"C:\Users\HP\OneDrive\Desktop\{filename}{ext}","w"):
                        pass
            except:
                print("Sir,I couldn't find any file type")
        else:
            with open(fr"C:\Users\HP\OneDrive\Desktop\demo{ext}","w"):
                pass
    else:
        print("Sir,please provide valid file type")
        pass



create_file("ultron create a json file named hello")