...
from Automation.createfile import create_file,save_file
...
def Auto_main_brain(text:str):
    ...
    if "open" in text:
    ...
    elif any(word in text.lower() for word in ["email","content","generate","mail","blog","summary","report","dataset","data","question","questions","qna"]):
        save_file(text)
        ...
        "shutdown", "restart", "slresult.pdfeep", "lock",
        "power off", "turn off", "terminate"
